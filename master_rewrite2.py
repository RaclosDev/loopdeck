...
new_studyhub = '''import { useState, useEffect, useRef } from 'react';
  ...
  return (
    <div className="fade-in pb-12" style={{ maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
        ...
        {/* REPASO ESPACIADO */}
        <div className="card start-workout-option start-workout-option-primary" style={{ padding: '1rem', cursor: 'pointer' }} onClick={() => navigate(`/study/${deckId}`)}>
        ...
        {/* GUÍA DE ESTUDIO */}
        <div className="card start-workout-option start-workout-option-secondary" style={{ padding: '1rem', cursor: 'pointer' }} onClick={() => navigate(`/hub/${deckId}/guide`)}>
        ...
        {/* MODO PASEO */}
        <div className="card start-workout-option start-workout-option-secondary" style={{ padding: '1rem', cursor: 'pointer' }} onClick={() => navigate(`/hub/${deckId}/explore`)}>
        ...
        {/* TEST POR BLOQUES */}
        <div className="card start-workout-option start-workout-option-secondary" style={{ padding: '1rem', cursor: 'pointer' }} onClick={() => navigate(`/hub/${deckId}/chunked`)}>
        ...
        {/* TEST DE OPCIONES */}
        <div className="card start-workout-option start-workout-option-secondary" style={{ padding: '1rem', cursor: 'pointer' }} onClick={() => navigate(`/hub/${deckId}/quiz`)}>
        ...
        {/* TUTOR IA */}
        <div className="card start-workout-option start-workout-option-secondary" style={{ padding: '1rem', cursor: 'pointer' }} onClick={() => navigate(`/hub/${deckId}/tutor`)}>
...
with open('src/pages/StudyHub.tsx', 'w', encoding='utf-8') as f:
    f.write(new_studyhub)

print("StudyHub rewritten")
